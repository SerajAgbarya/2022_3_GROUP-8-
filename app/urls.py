...
urlpatterns = [
    ...
    path('student/scholarship/create/', scholarship_services.scholarship_form_request_view,
         name='scholarship_form_request_view'),
    path('student/scholarship/', scholarship_services.scholarship_view_and_edit, name='scholarship_view'),
    path('student/scholarship/edit/', scholarship_services.scholarship_view_and_edit, name='scholarship_view_edit'),
